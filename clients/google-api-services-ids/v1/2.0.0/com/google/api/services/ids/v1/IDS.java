 ...
 *
 * <p>
 * This service uses {@link IDSRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class IDS extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "2.0.0 of the Cloud IDS API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://ids.googleapis.com/";
   ...
   * @since 1.31
   */
  public static final String DEFAULT_MTLS_ROOT_URL = "https://ids.mtls.googleapis.com/";
   ...
   * @since 1.7
   */
  public IDS(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
   ...
   * <pre>
   *   {@code IDS ids = new IDS(...);}
   *   {@code IDS.Projects.List request = ids.projects().list(parameters ...)}
   * </pre>
   *
  ...
  public class Projects {
     ...
     * <pre>
     *   {@code IDS ids = new IDS(...);}
     *   {@code IDS.Locations.List request = ids.locations().list(parameters ...)}
     * </pre>
     *
     * @return the resource collection
     */
    ...
    public class Locations {
      ...
      public class Get extends IDSRequest<com.google.api.services.ids.v1.model.Location> {
         ...
         * Create a request for the method "locations.get".
         *
         * This request holds the parameters needed by the the ids server.  After setting any optional
        ...
        protected Get(java.lang.String name) {
          super(IDS.this, "GET", REST_PATH, null, com.google.api.services.ids.v1.model.Location.class);
      ...
      public class List extends IDSRequest<com.google.api.services.ids.v1.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(IDS.this, "GET", REST_PATH, null, com.google.api.services.ids.v1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * <pre>
       *   {@code IDS ids = new IDS(...);}
       *   {@code IDS.Endpoints.List request = ids.endpoints().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      ...
      public class Endpoints {
         ...
         * @param content the {@link com.google.api.services.ids.v1.model.Endpoint}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.ids.v1.model.Endpoint content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends IDSRequest<com.google.api.services.ids.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.ids.v1.model.Endpoint content) {
            super(IDS.this, "POST", REST_PATH, content, com.google.api.services.ids.v1.model.Operation.class);
           ...
           * numbers, or hyphens, and cannot end with a hyphen. Values that do not match this
           * pattern will trigger an INVALID_ARGUMENT error.
           */
          @com.google.api.client.util.Key
          private java.lang.String endpointId;

          /** Required. The endpoint identifier. This will be part of the endpoint's resource name. This value
         must start with a lowercase letter followed by up to 62 lowercase letters, numbers, or hyphens, and
         cannot end with a hyphen. Values that do not match this pattern will trigger an INVALID_ARGUMENT
         error.
           */
        ...
        public class Delete extends IDSRequest<com.google.api.services.ids.v1.model.Operation> {
          ...
          protected Delete(java.lang.String name) {
            super(IDS.this, "DELETE", REST_PATH, null, com.google.api.services.ids.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends IDSRequest<com.google.api.services.ids.v1.model.Endpoint> {
         ...
         *        projects/{project}/locations/{location}/endpoints/{endpoint}
           ...
           */
          protected Get(java.lang.String name) {
            super(IDS.this, "GET", REST_PATH, null, com.google.api.services.ids.v1.model.Endpoint.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends IDSRequest<com.google.api.services.ids.v1.model.ListEndpointsResponse> {
          ...
          protected List(java.lang.String parent) {
            super(IDS.this, "GET", REST_PATH, null, com.google.api.services.ids.v1.model.ListEndpointsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         https://google.aip.dev/132#ordering.
          ...
          /**
           * Optional. The maximum number of endpoints to return. The service may return fewer than
           * this value.
           */
          @com.google.api.client.util.Key
          private java.lang.Integer pageSize;
          ...
          /**
           * Optional. A page token, received from a previous `ListEndpoints` call. Provide this to
          ...
          /** Optional. A page token, received from a previous `ListEndpoints` call. Provide this to retrieve the
         subsequent page. When paginating, all other parameters provided to `ListEndpoints` must match the
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.ids.v1.model.Endpoint content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends IDSRequest<com.google.api.services.ids.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.ids.v1.model.Endpoint content) {
            super(IDS.this, "PATCH", REST_PATH, content, com.google.api.services.ids.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         UUID is not supported (00000000-0000-0000-0000-000000000000).
          ...
          /**
           * Field mask is used to specify the fields to be overwritten in the Endpoint resource by
          ...
          /** Field mask is used to specify the fields to be overwritten in the Endpoint resource by the update.
       ...
       * <pre>
       *   {@code IDS ids = new IDS(...);}
       *   {@code IDS.Operations.List request = ids.operations().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      ...
      public class Operations {
         ...
         * @param content the {@link com.google.api.services.ids.v1.model.CancelOperationRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.api.services.ids.v1.model.CancelOperationRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends IDSRequest<com.google.api.services.ids.v1.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.ids.v1.model.CancelOperationRequest content) {
            super(IDS.this, "POST", REST_PATH, content, com.google.api.services.ids.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Delete extends IDSRequest<com.google.api.services.ids.v1.model.Empty> {
           ...
           */
          protected Delete(java.lang.String name) {
            super(IDS.this, "DELETE", REST_PATH, null, com.google.api.services.ids.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends IDSRequest<com.google.api.services.ids.v1.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(IDS.this, "GET", REST_PATH, null, com.google.api.services.ids.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends IDSRequest<com.google.api.services.ids.v1.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(IDS.this, "GET", REST_PATH, null, com.google.api.services.ids.v1.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link IDS}. */
    @Override
    public IDS build() {
      return new IDS(this);
    }
    ...
    /**
     * Set the {@link IDSRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setIDSRequestInitializer(
        IDSRequestInitializer idsRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(idsRequestInitializer);
    }
