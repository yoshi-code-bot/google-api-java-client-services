...
public class CloudObservability extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Folders {
    ...
    public class Locations {
      ...
      public class GetSettings extends CloudObservabilityRequest<com.google.api.services.observability.v1.model.Settings> {

        private static final String REST_PATH = "v1/{+name}";

        private final java.util.regex.Pattern NAME_PATTERN =
            java.util.regex.Pattern.compile("^folders/[^/]+/locations/[^/]+/settings$");
       ...
       *        "organizations/[ORGANIZATION_ID]/locations/[LOCATION]/settings"
        ...
        protected GetSettings(java.lang.String name) {
          super(CloudObservability.this, "GET", REST_PATH, null, com.google.api.services.observability.v1.model.Settings.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
                "^folders/[^/]+/locations/[^/]+/settings$");
          }
        }
       ...
       * @param content the {@link com.google.api.services.observability.v1.model.Settings}
       * @return the request
       */
      public UpdateSettings updateSettings(java.lang.String name, com.google.api.services.observability.v1.model.Settings content) throws java.io.IOException {
        UpdateSettings result = new UpdateSettings(name, content);
        initialize(result);
        return result;
      }

      public class UpdateSettings extends CloudObservabilityRequest<com.google.api.services.observability.v1.model.Operation> {
         ...
         * @since 1.13
         */
        protected UpdateSettings(java.lang.String name, com.google.api.services.observability.v1.model.Settings content) {
