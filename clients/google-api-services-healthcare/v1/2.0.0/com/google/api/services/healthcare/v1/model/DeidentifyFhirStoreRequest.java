...
public final class DeidentifyFhirStoreRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. The name of the FHIR store to write the redacted data to. For example, `projects/{pro
   * ject_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}`. * The
   * destination dataset and FHIR store must exist. * The source dataset and destination dataset
   * must both reside in the same location. De-identifying data across multiple locations is not
   * supported. * The caller must have the healthcare.fhirResources.update permission to write to
   * the destination FHIR store.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
