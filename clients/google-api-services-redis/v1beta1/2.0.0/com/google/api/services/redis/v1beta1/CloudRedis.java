...
public class CloudRedis extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class GetSharedRegionalCertificateAuthority extends CloudRedisRequest<com.google.api.services.redis.v1beta1.model.SharedRegionalCertificateAuthority> {
       ...
       *        `location_id` refers to a Google Cloud region.
        ...
        protected GetSharedRegionalCertificateAuthority(java.lang.String name) {
          super(CloudRedis.this, "GET", REST_PATH, null, com.google.api.services.redis.v1beta1.model.SharedRegionalCertificateAuthority.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Clusters {
         ...
         * @param content the {@link com.google.api.services.redis.v1beta1.model.AddTokenAuthUserRequest}
         * @return the request
         */
        public AddTokenAuthUser addTokenAuthUser(java.lang.String cluster, com.google.api.services.redis.v1beta1.model.AddTokenAuthUserRequest content) throws java.io.IOException {
          AddTokenAuthUser result = new AddTokenAuthUser(cluster, content);
          initialize(result);
          return result;
        }

        public class AddTokenAuthUser extends CloudRedisRequest<com.google.api.services.redis.v1beta1.model.Operation> {

          private static final String REST_PATH = "v1beta1/{+cluster}:addTokenAuthUser";
         ...
         *        projects/{project}/locations/{location}/clusters/{cluster}
           ...
           * @since 1.13
           */
          protected AddTokenAuthUser(java.lang.String cluster, com.google.api.services.redis.v1beta1.model.AddTokenAuthUserRequest content) {
            super(CloudRedis.this, "POST", REST_PATH, content, com.google.api.services.redis.v1beta1.model.Operation.class);
        ...
        public class TokenAuthUsers {
           ...
           *        }
           * @param content the {@link com.google.api.services.redis.v1beta1.model.AddAuthTokenRequest}
           * @return the request
           */
          public AddAuthToken addAuthToken(java.lang.String tokenAuthUser, com.google.api.services.redis.v1beta1.model.AddAuthTokenRequest content) throws java.io.IOException {
            AddAuthToken result = new AddAuthToken(tokenAuthUser, content);
            initialize(result);
            return result;
          }

          public class AddAuthToken extends CloudRedisRequest<com.google.api.services.redis.v1beta1.model.Operation> {

            private static final String REST_PATH = "v1beta1/{+tokenAuthUser}:addAuthToken";
           ...
           *        }
             ...
             * @since 1.13
             */
            protected AddAuthToken(java.lang.String tokenAuthUser, com.google.api.services.redis.v1beta1.model.AddAuthTokenRequest content) {
              super(CloudRedis.this, "POST", REST_PATH, content, com.google.api.services.redis.v1beta1.model.Operation.class);
          ...
          public class Get extends CloudRedisRequest<com.google.api.services.redis.v1beta1.model.TokenAuthUser> {
           ...
           *        }
             ...
             */
            protected Get(java.lang.String name) {
              super(CloudRedis.this, "GET", REST_PATH, null, com.google.api.services.redis.v1beta1.model.TokenAuthUser.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends CloudRedisRequest<com.google.api.services.redis.v1beta1.model.ListTokenAuthUsersResponse> {

            private static final String REST_PATH = "v1beta1/{+parent}/tokenAuthUsers";
           ...
           *        projects/{project}/locations/{location}/clusters/{cluster}
             ...
             */
            protected List(java.lang.String parent) {
              super(CloudRedis.this, "GET", REST_PATH, null, com.google.api.services.redis.v1beta1.model.ListTokenAuthUsersResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
          ...
          public class AuthTokens {
            ...
            public class Get extends CloudRedisRequest<com.google.api.services.redis.v1beta1.model.AuthToken> {
             ...
             *        token}
               ...
               */
              protected Get(java.lang.String name) {
                super(CloudRedis.this, "GET", REST_PATH, null, com.google.api.services.redis.v1beta1.model.AuthToken.class);
                this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                      "Parameter name must conform to the pattern " +
            ...
            public class List extends CloudRedisRequest<com.google.api.services.redis.v1beta1.model.ListAuthTokensResponse> {

              private static final String REST_PATH = "v1beta1/{+parent}/authTokens";
             ...
             *        }
               ...
               */
              protected List(java.lang.String parent) {
                super(CloudRedis.this, "GET", REST_PATH, null, com.google.api.services.redis.v1beta1.model.ListAuthTokensResponse.class);
                this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                      "Parameter parent must conform to the pattern " +
