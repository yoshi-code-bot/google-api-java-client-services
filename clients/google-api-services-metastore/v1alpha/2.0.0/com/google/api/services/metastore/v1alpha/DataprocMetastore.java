  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Operations {
         ...
         * @param content the {@link com.google.api.services.metastore.v1alpha.model.CancelOperationRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.api.services.metastore.v1alpha.model.CancelOperationRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends DataprocMetastoreRequest<com.google.api.services.metastore.v1alpha.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.metastore.v1alpha.model.CancelOperationRequest content) {
            super(DataprocMetastore.this, "POST", REST_PATH, content, com.google.api.services.metastore.v1alpha.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class Services {
         ...
         * @param content the {@link com.google.api.services.metastore.v1alpha.model.CancelMigrationRequest}
         * @return the request
         */
        public CancelMigration cancelMigration(java.lang.String service, com.google.api.services.metastore.v1alpha.model.CancelMigrationRequest content) throws java.io.IOException {
          CancelMigration result = new CancelMigration(service, content);
          initialize(result);
          return result;
        }

        public class CancelMigration extends DataprocMetastoreRequest<com.google.api.services.metastore.v1alpha.model.Operation> {

          private static final String REST_PATH = "v1alpha/{+service}:cancelMigration";
         ...
         *        the following format:projects/{project_id}/locations/{location_id}/services/{service_id}.
           ...
           * @since 1.13
           */
          protected CancelMigration(java.lang.String service, com.google.api.services.metastore.v1alpha.model.CancelMigrationRequest content) {
            super(DataprocMetastore.this, "POST", REST_PATH, content, com.google.api.services.metastore.v1alpha.model.Operation.class);
            this.service = com.google.api.client.util.Preconditions.checkNotNull(service, "Required parameter service must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(SERVICE_PATTERN.matcher(service).matches(),
         ...
         * @param content the {@link com.google.api.services.metastore.v1alpha.model.CompleteMigrationRequest}
         * @return the request
         */
        public CompleteMigration completeMigration(java.lang.String service, com.google.api.services.metastore.v1alpha.model.CompleteMigrationRequest content) throws java.io.IOException {
          CompleteMigration result = new CompleteMigration(service, content);
          initialize(result);
          return result;
        }

        public class CompleteMigration extends DataprocMetastoreRequest<com.google.api.services.metastore.v1alpha.model.Operation> {

          private static final String REST_PATH = "v1alpha/{+service}:completeMigration";
         ...
         *        following format:projects/{project_id}/locations/{location_id}/services/{service_id}.
           ...
           * @since 1.13
           */
          protected CompleteMigration(java.lang.String service, com.google.api.services.metastore.v1alpha.model.CompleteMigrationRequest content) {
            super(DataprocMetastore.this, "POST", REST_PATH, content, com.google.api.services.metastore.v1alpha.model.Operation.class);
            this.service = com.google.api.client.util.Preconditions.checkNotNull(service, "Required parameter service must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(SERVICE_PATTERN.matcher(service).matches(),
         ...
         *        following format:projects/{project_id}/locations/{location_id}/services/{service_id}.
         * @param content the {@link com.google.api.services.metastore.v1alpha.model.StartMigrationRequest}
         * @return the request
         */
        public StartMigration startMigration(java.lang.String service, com.google.api.services.metastore.v1alpha.model.StartMigrationRequest content) throws java.io.IOException {
          StartMigration result = new StartMigration(service, content);
          initialize(result);
          return result;
        }

        public class StartMigration extends DataprocMetastoreRequest<com.google.api.services.metastore.v1alpha.model.Operation> {

          private static final String REST_PATH = "v1alpha/{+service}:startMigration";
         ...
         *        following format:projects/{project_id}/locations/{location_id}/services/{service_id}.
           ...
           * @since 1.13
           */
          protected StartMigration(java.lang.String service, com.google.api.services.metastore.v1alpha.model.StartMigrationRequest content) {
            super(DataprocMetastore.this, "POST", REST_PATH, content, com.google.api.services.metastore.v1alpha.model.Operation.class);
            this.service = com.google.api.client.util.Preconditions.checkNotNull(service, "Required parameter service must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(SERVICE_PATTERN.matcher(service).matches(),
        ...
        public class MigrationExecutions {
          ...
          public class Get extends DataprocMetastoreRequest<com.google.api.services.metastore.v1alpha.model.MigrationExecution> {
           ...
           *        /{migration_execution_id}.
             ...
             */
            protected Get(java.lang.String name) {
              super(DataprocMetastore.this, "GET", REST_PATH, null, com.google.api.services.metastore.v1alpha.model.MigrationExecution.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends DataprocMetastoreRequest<com.google.api.services.metastore.v1alpha.model.ListMigrationExecutionsResponse> {

            private static final String REST_PATH = "v1alpha/{+parent}/migrationExecutions";
           ...
           *        rationExecutions.
             ...
             */
            protected List(java.lang.String parent) {
              super(DataprocMetastore.this, "GET", REST_PATH, null, com.google.api.services.metastore.v1alpha.model.ListMigrationExecutionsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
