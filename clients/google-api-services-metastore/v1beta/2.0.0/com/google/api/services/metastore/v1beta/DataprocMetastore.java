  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Operations {
         ...
         * @param content the {@link com.google.api.services.metastore.v1beta.model.CancelOperationRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.api.services.metastore.v1beta.model.CancelOperationRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends DataprocMetastoreRequest<com.google.api.services.metastore.v1beta.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.metastore.v1beta.model.CancelOperationRequest content) {
            super(DataprocMetastore.this, "POST", REST_PATH, content, com.google.api.services.metastore.v1beta.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class Services {
         ...
         *        format:projects/{project_id}/locations/{location_id}/services/{service_id}.
         * @param content the {@link com.google.api.services.metastore.v1beta.model.AlterTablePropertiesRequest}
         * @return the request
         */
        public AlterTableProperties alterTableProperties(java.lang.String service, com.google.api.services.metastore.v1beta.model.AlterTablePropertiesRequest content) throws java.io.IOException {
          AlterTableProperties result = new AlterTableProperties(service, content);
          initialize(result);
          return result;
        }

        public class AlterTableProperties extends DataprocMetastoreRequest<com.google.api.services.metastore.v1beta.model.Operation> {

          private static final String REST_PATH = "v1beta/{+service}:alterTableProperties";
         ...
         *        format:projects/{project_id}/locations/{location_id}/services/{service_id}.
           ...
           * @since 1.13
           */
          protected AlterTableProperties(java.lang.String service, com.google.api.services.metastore.v1beta.model.AlterTablePropertiesRequest content) {
            super(DataprocMetastore.this, "POST", REST_PATH, content, com.google.api.services.metastore.v1beta.model.Operation.class);
            this.service = com.google.api.client.util.Preconditions.checkNotNull(service, "Required parameter service must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(SERVICE_PATTERN.matcher(service).matches(),
