...
public final class ApprovalList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<Approval> items;

  static {
    // hack to force ProGuard to consider Approval used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(Approval.class);
  }
   ...
   */
  public java.util.List<Approval> getItems() {
    return items;
  }
   ...
   */
  public ApprovalList setItems(java.util.List<Approval> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ApprovalList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ApprovalList setNextPageToken(java.lang.String nextPageToken) {
    this.nextPageToken = nextPageToken;
    return this;
  }

  @Override
  public ApprovalList set(String fieldName, Object value) {
    return (ApprovalList) super.set(fieldName, value);
  }
