...
/**
 * Service definition for Merchant (issueresolution_v1).
 *
 * <p>
...
public class Merchant extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Accounts {
    ...
    public class AggregateProductStatuses {
      ...
      public class List extends MerchantRequest<com.google.api.services.merchantapi.issueresolution_v1.model.ListAggregateProductStatusesResponse> {

        private static final String REST_PATH = "issueresolution/v1/{+parent}/aggregateProductStatuses";
        ...
        protected List(java.lang.String parent) {
          super(Merchant.this, "GET", REST_PATH, null, com.google.api.services.merchantapi.issueresolution_v1.model.ListAggregateProductStatusesResponse.class);
  ...
  public class Issueresolution {
     ...
     * @return the request
     */
    public Renderaccountissues renderaccountissues(java.lang.String name, com.google.api.services.merchantapi.issueresolution_v1.model.RenderIssuesRequestPayload content) throws java.io.IOException {
      Renderaccountissues result = new Renderaccountissues(name, content);
      initialize(result);
      return result;
    }

    public class Renderaccountissues extends MerchantRequest<com.google.api.services.merchantapi.issueresolution_v1.model.RenderAccountIssuesResponse> {

      private static final String REST_PATH = "issueresolution/v1/{+name}:renderaccountissues";
       ...
       * @since 1.13
       */
      protected Renderaccountissues(java.lang.String name, com.google.api.services.merchantapi.issueresolution_v1.model.RenderIssuesRequestPayload content) {
        super(Merchant.this, "POST", REST_PATH, content, com.google.api.services.merchantapi.issueresolution_v1.model.RenderAccountIssuesResponse.class);
     ...
     * @return the request
     */
    public Renderproductissues renderproductissues(java.lang.String name, com.google.api.services.merchantapi.issueresolution_v1.model.RenderIssuesRequestPayload content) throws java.io.IOException {
      Renderproductissues result = new Renderproductissues(name, content);
      initialize(result);
      return result;
    }

    public class Renderproductissues extends MerchantRequest<com.google.api.services.merchantapi.issueresolution_v1.model.RenderProductIssuesResponse> {

      private static final String REST_PATH = "issueresolution/v1/{+name}:renderproductissues";
     ...
     *        formats.
       ...
       * @since 1.13
       */
      protected Renderproductissues(java.lang.String name, com.google.api.services.merchantapi.issueresolution_v1.model.RenderIssuesRequestPayload content) {
        super(Merchant.this, "POST", REST_PATH, content, com.google.api.services.merchantapi.issueresolution_v1.model.RenderProductIssuesResponse.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
     ...
     * allowlist. You can submit an allowlist request in the [Shopping API Support
     * Form](https://support.google.com/merchants/contact/shopping_api_support_form) under "What is the
     * issue/question?" to get access to this feature. The action can be successfully started only once
     * all `required` inputs are provided. If any `required` input is missing, or invalid value was
     ...
     * @param content the {@link com.google.api.services.merchantapi.issueresolution_v1.model.TriggerActionPayload}
     * @return the request
     */
    public Triggeraction triggeraction(java.lang.String name, com.google.api.services.merchantapi.issueresolution_v1.model.TriggerActionPayload content) throws java.io.IOException {
      Triggeraction result = new Triggeraction(name, content);
      initialize(result);
      return result;
    }

    public class Triggeraction extends MerchantRequest<com.google.api.services.merchantapi.issueresolution_v1.model.TriggerActionResponse> {

      private static final String REST_PATH = "issueresolution/v1/{+name}:triggeraction";
       ...
       * restricted to an allowlist. You can submit an allowlist request in the [Shopping API Support
       ...
       * @since 1.13
       */
      protected Triggeraction(java.lang.String name, com.google.api.services.merchantapi.issueresolution_v1.model.TriggerActionPayload content) {
        super(Merchant.this, "POST", REST_PATH, content, com.google.api.services.merchantapi.issueresolution_v1.model.TriggerActionResponse.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
