...
public final class ProductAttributes extends com.google.api.client.json.GenericJson {
  ...
  /**
   * System in which the size is specified. Recommended for apparel items. For more information, see
   ...
   */
  @com.google.api.client.util.Key
  private StructuredTitle structuredTitle;
   ...
   */
  public ProductAttributes setAdditionalImageLinks(java.util.List<java.lang.String> additionalImageLinks) {
   ...
   */
  public ProductAttributes setAdsGrouping(java.lang.String adsGrouping) {
   ...
   */
  public ProductAttributes setAdsLabels(java.util.List<java.lang.String> adsLabels) {
   ...
   */
  public ProductAttributes setAdsRedirect(java.lang.String adsRedirect) {
   ...
   */
  public ProductAttributes setAdult(java.lang.Boolean adult) {
    this.adult = adult;
    return this;
  }
   ...
   */
  public ProductAttributes setAutoPricingMinPrice(Price autoPricingMinPrice) {
   ...
   */
  public ProductAttributes setAvailability(java.lang.String availability) {
   ...
   */
  public ProductAttributes setAvailabilityDate(String availabilityDate) {
   ...
   */
  public ProductAttributes setBrand(java.lang.String brand) {
    this.brand = brand;
    return this;
  }
   ...
   */
  public ProductAttributes setColor(java.lang.String color) {
    this.color = color;
    return this;
  }
   ...
   */
  public ProductAttributes setCondition(java.lang.String condition) {
   ...
   */
  public ProductAttributes setCostOfGoodsSold(Price costOfGoodsSold) {
   ...
   */
  public ProductAttributes setCustomLabel0(java.lang.String customLabel0) {
   ...
   */
  public ProductAttributes setCustomLabel1(java.lang.String customLabel1) {
   ...
   */
  public ProductAttributes setCustomLabel2(java.lang.String customLabel2) {
   ...
   */
  public ProductAttributes setCustomLabel3(java.lang.String customLabel3) {
   ...
   */
  public ProductAttributes setCustomLabel4(java.lang.String customLabel4) {
   ...
   */
  public ProductAttributes setDescription(java.lang.String description) {
   ...
   */
  public ProductAttributes setDisplayAdsId(java.lang.String displayAdsId) {
   ...
   */
  public ProductAttributes setDisplayAdsLink(java.lang.String displayAdsLink) {
   ...
   */
  public ProductAttributes setDisplayAdsSimilarIds(java.util.List<java.lang.String> displayAdsSimilarIds) {
   ...
   */
  public ProductAttributes setDisplayAdsTitle(java.lang.String displayAdsTitle) {
   ...
   */
  public ProductAttributes setDisplayAdsValue(java.lang.Double displayAdsValue) {
   ...
   */
  public ProductAttributes setExcludedDestinations(java.util.List<java.lang.String> excludedDestinations) {
   ...
   */
  public ProductAttributes setExpirationDate(String expirationDate) {
   ...
   */
  public ProductAttributes setExternalSellerId(java.lang.String externalSellerId) {
   ...
   */
  public ProductAttributes setGender(java.lang.String gender) {
    this.gender = gender;
    return this;
  }
   ...
   */
  public ProductAttributes setGoogleProductCategory(java.lang.String googleProductCategory) {
   ...
   */
  public ProductAttributes setIdentifierExists(java.lang.Boolean identifierExists) {
   ...
   */
  public ProductAttributes setImageLink(java.lang.String imageLink) {
   ...
   */
  public ProductAttributes setIncludedDestinations(java.util.List<java.lang.String> includedDestinations) {
   ...
   */
  public ProductAttributes setInstallment(ProductInstallment installment) {
   ...
   */
  public ProductAttributes setIsBundle(java.lang.Boolean isBundle) {
   ...
   */
  public ProductAttributes setLifestyleImageLinks(java.util.List<java.lang.String> lifestyleImageLinks) {
   ...
   */
  public ProductAttributes setLink(java.lang.String link) {
    this.link = link;
    return this;
  }
   ...
   */
  public ProductAttributes setLoyaltyPoints(LoyaltyPoints loyaltyPoints) {
   ...
   */
  public ProductAttributes setLoyaltyPrograms(java.util.List<LoyaltyProgram> loyaltyPrograms) {
   ...
   */
  public ProductAttributes setMaterial(java.lang.String material) {
   ...
   */
  public ProductAttributes setMaxEnergyEfficiencyClass(java.lang.String maxEnergyEfficiencyClass) {
   ...
   */
  public ProductAttributes setMaxHandlingTime(java.lang.Long maxHandlingTime) {
   ...
   */
  public ProductAttributes setMaximumRetailPrice(Price maximumRetailPrice) {
   ...
   */
  public ProductAttributes setMinEnergyEfficiencyClass(java.lang.String minEnergyEfficiencyClass) {
   ...
   */
  public ProductAttributes setMobileLink(java.lang.String mobileLink) {
   ...
   */
  public ProductAttributes setMpn(java.lang.String mpn) {
    this.mpn = mpn;
    return this;
  }
   ...
   */
  public ProductAttributes setMultipack(java.lang.Long multipack) {
   ...
   */
  public ProductAttributes setPattern(java.lang.String pattern) {
   ...
   */
  public ProductAttributes setPickupMethod(java.lang.String pickupMethod) {
   ...
   */
  public ProductAttributes setPickupSla(java.lang.String pickupSla) {
   ...
   */
  public ProductAttributes setPrice(Price price) {
    this.price = price;
    return this;
  }
   ...
   */
  public ProductAttributes setProductHeight(ProductDimension productHeight) {
   ...
   */
  public ProductAttributes setProductHighlights(java.util.List<java.lang.String> productHighlights) {
   ...
   */
  public ProductAttributes setProductLength(ProductDimension productLength) {
   ...
   */
  public ProductAttributes setProductTypes(java.util.List<java.lang.String> productTypes) {
   ...
   */
  public ProductAttributes setProductWeight(ProductWeight productWeight) {
   ...
   */
  public ProductAttributes setProductWidth(ProductDimension productWidth) {
   ...
   */
  public ProductAttributes setSalePrice(Price salePrice) {
   ...
   */
  public ProductAttributes setSalePriceEffectiveDate(Interval salePriceEffectiveDate) {
   ...
   */
  public ProductAttributes setSellOnGoogleQuantity(java.lang.Long sellOnGoogleQuantity) {
   ...
   */
  public ProductAttributes setShipping(java.util.List<Shipping> shipping) {
   ...
   */
  public ProductAttributes setShippingHeight(ShippingDimension shippingHeight) {
   ...
   */
  public ProductAttributes setShippingWeight(ShippingWeight shippingWeight) {
   ...
   */
  public ProductAttributes setShippingWidth(ShippingDimension shippingWidth) {
   ...
   */
  public ProductAttributes setShoppingAdsExcludedCountries(java.util.List<java.lang.String> shoppingAdsExcludedCountries) {
   ...
   */
  public ProductAttributes setSize(java.lang.String size) {
    this.size = size;
    return this;
  }
   ...
   */
  public ProductAttributes setSizeSystem(java.lang.String sizeSystem) {
   ...
   */
  public ProductAttributes setStructuredDescription(StructuredDescription structuredDescription) {
   ...
   */
  public ProductAttributes setStructuredTitle(StructuredTitle structuredTitle) {
   ...
   */
  public ProductAttributes setSubscriptionCost(SubscriptionCost subscriptionCost) {
   ...
   */
  public ProductAttributes setSustainabilityIncentives(java.util.List<ProductSustainabilityIncentive> sustainabilityIncentives) {
   ...
   */
  public ProductAttributes setTitle(java.lang.String title) {
    this.title = title;
    return this;
  }
   ...
   */
  public ProductAttributes setTransitTimeLabel(java.lang.String transitTimeLabel) {
   ...
   */
  public ProductAttributes setUnitPricingBaseMeasure(UnitPricingBaseMeasure unitPricingBaseMeasure) {
  ...
  @Override
  public ProductAttributes set(String fieldName, Object value) {
    return (ProductAttributes) super.set(fieldName, value);
  }

  @Override
  public ProductAttributes clone() {
    return (ProductAttributes) super.clone();
  }
