  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Services {
         ...
         * @return the request
         */
        public IntrospectGraphql introspectGraphql(java.lang.String name, com.google.api.services.firebasedataconnect.v1beta.model.GraphqlRequest content) throws java.io.IOException {
          IntrospectGraphql result = new IntrospectGraphql(name, content);
          initialize(result);
          return result;
        }

        public class IntrospectGraphql extends FirebaseDataConnectRequest<com.google.api.services.firebasedataconnect.v1beta.model.GraphqlResponse> {

          private static final String REST_PATH = "v1beta/{+name}:introspectGraphql";
         ...
         *        projects/{project}/locations/{location}/services/{service} ```
           ...
           * @since 1.13
           */
          protected IntrospectGraphql(java.lang.String name, com.google.api.services.firebasedataconnect.v1beta.model.GraphqlRequest content) {
            super(FirebaseDataConnect.this, "POST", REST_PATH, content, com.google.api.services.firebasedataconnect.v1beta.model.GraphqlResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        public class Connectors {
           ...
           *        ``` projects/{project}/locations/{location}/services/{service}/connectors/{connector} ```
           * @param content the {@link com.google.api.services.firebasedataconnect.v1beta.model.ImpersonateRequest}
           * @return the request
           */
          public ImpersonateMutation impersonateMutation(java.lang.String name, com.google.api.services.firebasedataconnect.v1beta.model.ImpersonateRequest content) throws java.io.IOException {
            ImpersonateMutation result = new ImpersonateMutation(name, content);
            initialize(result);
            return result;
          }

          public class ImpersonateMutation extends FirebaseDataConnectRequest<com.google.api.services.firebasedataconnect.v1beta.model.GraphqlResponse> {

            private static final String REST_PATH = "v1beta/{+name}:impersonateMutation";
           ...
           *        ``` projects/{project}/locations/{location}/services/{service}/connectors/{connector} ```
             ...
             * @since 1.13
             */
            protected ImpersonateMutation(java.lang.String name, com.google.api.services.firebasedataconnect.v1beta.model.ImpersonateRequest content) {
              super(FirebaseDataConnect.this, "POST", REST_PATH, content, com.google.api.services.firebasedataconnect.v1beta.model.GraphqlResponse.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
           ...
           * @return the request
           */
          public ImpersonateQuery impersonateQuery(java.lang.String name, com.google.api.services.firebasedataconnect.v1beta.model.ImpersonateRequest content) throws java.io.IOException {
            ImpersonateQuery result = new ImpersonateQuery(name, content);
            initialize(result);
            return result;
          }

          public class ImpersonateQuery extends FirebaseDataConnectRequest<com.google.api.services.firebasedataconnect.v1beta.model.GraphqlResponse> {

            private static final String REST_PATH = "v1beta/{+name}:impersonateQuery";
           ...
           *        ``` projects/{project}/locations/{location}/services/{service}/connectors/{connector} ```
             ...
             * @since 1.13
             */
            protected ImpersonateQuery(java.lang.String name, com.google.api.services.firebasedataconnect.v1beta.model.ImpersonateRequest content) {
              super(FirebaseDataConnect.this, "POST", REST_PATH, content, com.google.api.services.firebasedataconnect.v1beta.model.GraphqlResponse.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
